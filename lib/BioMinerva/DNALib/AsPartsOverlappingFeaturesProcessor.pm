...
package BioMinerva::DNALib::AsPartsOverlappingFeaturesProcessor;
...
sub create {
  return new BioMinerva::DNALib::AsPartsOverlappingFeaturesProcessor();
}
...
sub process_overlapping_features
{
  ...
  foreach my $feature( @{ $features || [] } ) {
    $mask_feature->add_part_feature( $feature );
  }
