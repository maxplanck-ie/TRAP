...
BioMinerva::Base::Argument - Utility functions for argument handling

=head1 SYNOPSIS

    use BioMinerva::Base::Argument qw(rearrange);
...
package BioMinerva::Base::Argument;
...
=head2 rearrange
 ...
 Example   : use Bio::EnsEMBL::Base::Argument qw(rearrange);
 ...
 Source    : This function was taken from CGI.pm, written by Dr. Lincoln
           ...
           : This has since been adapted as an exported static method in this 
             class Bio::EnsEMBL::Base::Argument 
 Comments  : (SAC)
