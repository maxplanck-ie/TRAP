...
"This script takes as input
	...
	3. output directory to indicate whether the matrix A should be reduced to entries listed in seqs
...
Usage: R -e \"rmarkdown::render('rankMotifs_groups.Rmd')\" --args matrix.mat gene.list out.directory [reduceA] \n"

# set default files (examples) and directory
f1="trap.Rds"
f2="liver.tsv"
dn=paste0("rankMotifs_groups.", pid)   # directory with process-ID
...
if (la>3) { reduceA= grepl( paste0("^",args(4)), "reduceA",ignore.case=TRUE) }  # TRUE if third argument is specified and is (or abbreviates) "reduceA"
